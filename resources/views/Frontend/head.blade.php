<head>
    ...
    <link href="{{ URL::asset('Frontend/assets/vendor/icofont/icofont.min.css') }}" rel="stylesheet">
    <link href="{{ URL::asset('Frontend/assets/vendor/boxicons/css/boxicons.min.css') }}" rel="stylesheet">
    <link href="{{ URL::asset('Frontend/assets/vendor/venobox/venobox.css') }}" rel="stylesheet">
    <link href="{{ URL::asset('Frontend/assets/vendor/owl.carousel/assets/owl.carousel.min.css') }}" rel="stylesheet">
